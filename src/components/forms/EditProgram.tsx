...
export default function EditPrograms( prop: Props) {
    ...
    const onSubmit = async (data: CreateProgram) => {
        ...
        try {
             const request = axios.post(`${process.env.NEXT_PUBLIC_API_URL}/program/editprogram`,{
                id: prop.id,
                name: data.name
  ...
  return (
    ...
    <DialogTrigger className=' light-btn'>
        <img src='/icons/pen.png' height={15} width={15}/>Edit
    </DialogTrigger>
    <DialogContent className=' text-xs'>
        <DialogHeader>
        <DialogTitle className=' text-lg'>Edit Program</DialogTitle>

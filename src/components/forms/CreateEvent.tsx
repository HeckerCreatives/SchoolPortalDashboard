...
import { createEvents, CreateEvents } from '@/validations/validatiion'
...
export default function CreateEvent() {
    ...
    const [file, setFile] = useState<File>()
      ...
      const {
        ...
        resolver: zodResolver(createEvents),
        defaultValues: {
    ...
    const onSubmit = async (data: CreateEvents) => {
        ...
        try {
             const request = axios.post(`${process.env.NEXT_PUBLIC_API_URL}/event/createevent`,{
                title: data.title,
    ...
    return (
        ...
        <DialogContent className=' text-xs max-h-[700px] overflow-y-auto '>
            <DialogHeader>
            <DialogTitle className=' text-lg'>Create Event</DialogTitle>

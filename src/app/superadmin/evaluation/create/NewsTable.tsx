...
import CreateNewsHeadline from '@/components/forms/CreateNews'
    ...
    const deleteAnnouncement = async (id: string) => {
        ...
        try {
            ...
            const response = await toast.promise(request, {
                loading: 'Deleting news/announcement....',
                success: `News/Announcement deleted successfully`,
                error: 'Error while deleting news/announcement',
            });
        ...
        <TableBody>
            {list.map((item, index) => (
                ...
                <TableCell className=' flex flex-wrap w-[250px] items-center gap-2'>
                   ...
                   <EditNews id={item.id} title={item.title} content={item.content} image={item.image}/>
                   ...
                   <Dialog open={modal} onOpenChange={setModal}>
                    ...
                    <DialogContent className=' text-xs'>
                        ...
                        <DialogDescription className=' text-xs'>
                            Are you sure you want to delete this news/announcement.
                        </DialogDescription>
                        </DialogHeader>
                        <div className=' w-full flex flex-col'>
                            ...
                            <button disabled={loading} onClick={() => deleteAnnouncement(item.id)} className=' action-danger'>
